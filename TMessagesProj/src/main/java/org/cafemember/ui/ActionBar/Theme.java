...
//    public static final int ACTION_BAR_COLOR = 0xff527da3;
    public static final int ACTION_BAR_COLOR = Color.parseColor("#578FB4");
    ...
    public static final int ACTION_BAR_PLAYER_COLOR = Color.BLACK;
    public static final int ACTION_BAR_TITLE_COLOR = Color.BLACK;
    public static final int ACTION_BAR_SUBTITLE_COLOR = Color.BLACK;
//    public static final int ACTION_BAR_PROFILE_COLOR = 0xff598fba;
    public static final int ACTION_BAR_PROFILE_COLOR = Color.BLACK;
    public static final int ACTION_BAR_PROFILE_SUBTITLE_COLOR = Color.BLACK;
//    public static final int ACTION_BAR_MAIN_AVATAR_COLOR = 0xff5085b1;
    public static final int ACTION_BAR_MAIN_AVATAR_COLOR = Color.BLACK;
    public static final int ACTION_BAR_ACTION_MODE_TEXT_COLOR = Color.BLACK;
    public static final int ACTION_BAR_SELECTOR_COLOR = Color.BLACK;
