...
//        serviceIntent.setPackage("ir.mservices.market");
        ...
        Intent serviceIntent = new Intent(BuildVars.MARKET_APPLICATION_ID + ".InAppBillingService.BIND");
        serviceIntent.setPackage(BuildVars.MARKET_PACKAGE);
        ...
        if (!mContext.getPackageManager().queryIntentServices(serviceIntent, 0).isEmpty()) {
            ...
            // no service available to handle that Intent0
            if (listener != null) {
