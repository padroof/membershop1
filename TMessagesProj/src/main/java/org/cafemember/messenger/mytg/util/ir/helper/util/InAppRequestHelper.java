...
import org.cafemember.messenger.mytg.util.ir.helper.interfaces.BaseInAppListener;

/**
 * abstract request helper for in-app billing requests that start an activity in IranApps
 * and receive the response in {@link android.app.Activity#onActivityResult(int, int, Intent)}
 *
