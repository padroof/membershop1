package org.cafemember.messenger.mytg.util.ir.helper.util;
...
import com.android.vending.billing.IranAppsIabService;
...
import org.cafemember.messenger.mytg.util.ir.helper.interfaces.SkuDetailListener;
...
public class InAppHelper {
     ...
     * </p>
     * you must always call {@link ir.tgbs.iranapps.billing.helper.util.InAppHelper#onActivityResult(int, int, Intent)}
     * from your {@link Activity#onActivityResult(int, int, Intent)}
     * otherwise the helper wouldn't work properly <p>
     * you also should call {@link InAppHelper#onActivityDestroy()} for your {@link Activity#onDestroy()}
     ...
     * @throws RemoteException on connection failure with billing service
     */
    ...
    /**
     * this method must be called inside {@link Activity#onDestroy()} <br>
     ...
     * {@link android.app.Fragment#onActivityResult(int, int, Intent)} <p>
